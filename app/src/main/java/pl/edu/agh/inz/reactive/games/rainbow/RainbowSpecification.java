...
public class RainbowSpecification implements GameSpecification {
    ...
    private Level[] levels = new Level[] {
            ...
            new Level.Builder(8, 3).bg(rainbow_bg_cook1).targets(1, 0.2, 3, rainbow_t_cake).build(),
            new Level.Builder(8, 3).bg(rainbow_bg_cook1).targets(1, 0.2, 3, rainbow_t_cake).build(),
            new Level.Builder(8, 3).bg(rainbow_bg_4).targets(1, 0.2, 3, rainbow_t_torte).build(),
