...
public class ThreeSpecification implements GameSpecification {
    ...
    public ThreeSpecification() {
        levels = new Level[] {
            ...
            new Level.Builder(10, 3, 50).setImages(new Integer[] { three_kw11, three_kw12, three_kw13 }).build(), // 6
            ...
            new Level.Builder(10, 4, 60).setImages(new Integer[] { three_clk11, three_clk12, three_clk13, three_clk01, three_clk02, three_clk03 }).build(),
            new Level.Builder(10, 4, 60).setImages(new Integer[] { three_clk01, three_clk02, three_clk03, three_clk11, three_clk12, three_clk13 }).build(), // 11
            ...
            new Level.Builder(10, 4, 60).setImages(new Integer[] { three_kw51, three_kw52, three_kw53, three_kw61, three_kw63  }).withRotatedPattern().build(),
